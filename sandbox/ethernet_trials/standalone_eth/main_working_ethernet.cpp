...
IPAddress myIP(192, 168, 86, 62);
IPAddress myGW(192,168,86,1);
// IP 192, 168, 86, 62 and gateway 192,168,86,1 worked when:
// - AX adapter configured as 192.168.86.61
// - AX adapter configured as 255.255.255.0
// - plugged into ethernet switch plugged into router
// - plugged directly to ethernet switch with router IP address specified in 
// AX adapter as 192.168.86.1 and wifi on OR router off <3 
